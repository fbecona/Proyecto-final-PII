...
Responsabilidades:
	Conocer y manejar los componentes del stage 2_3.
...
Patterns:
	Esta es la clase que tiene los datos necesarios para que el nivel 2_3 funcione, por lo tanto es 
...
public class Stage23View : BaseStageView
{
    public Text Text_A, Text_B, Text_C;
    public Dictionary<string, string> dicc{get; private set;}
    public override string imagesPath { get {return "Sprites23"; }}
    public override string stageName { get {return Constants.Stages.Stage2_3; }} 
    ...
    {
        dicc = TextLoad.TextLoad(@"Assets\Resources\Stage23Answers.txt");
    ...
    //Se puede ver como en este stage, al tener una sola imagen, tendria sentido si ChangeOption() usara
    //una lista en lugar de un diccionario, pero lo dejamos asi porque esta abierto a la posibilidad de 
    //que se agreguen mas imagenes y el stage seguiria funcioando sin necesidad de cambiar el codigo.
}