...
Responsabilidad:
	Conocer y manejar los componentes del stage 1_2.
...
Patterns:
	Esta es la clase que tiene los datos necesarios para que el nivel 1_2 funcione, por lo tanto es 
    la clase que da comienzo a dicho nivel.

 */

public class Stage12View : BaseStageView
{
    public override string imagesPath { get {return "Sprites12"; }}
    public override string stageName { get {return Constants.Stages.Stage1_2; }} 
