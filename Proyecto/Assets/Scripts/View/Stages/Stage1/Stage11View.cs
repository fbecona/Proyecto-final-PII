...
Responsabilidad:
	Conocer y manejar los componentes del stage 1_1.
...
Patterns:
	Esta es la clase que tiene los datos necesarios para que el nivel 1_1 funcione, por lo tanto es 
    la clase que da comienzo a dicho nivel.

 */

public class Stage11View : BaseStageView
{
    public override string imagesPath { get {return "Sprites11"; }}
    public override string stageName { get {return Constants.Stages.Stage1_1; }} 
